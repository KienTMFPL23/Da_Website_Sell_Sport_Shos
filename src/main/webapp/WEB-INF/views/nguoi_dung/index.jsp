...
<form th:action="/nguoi-dung/hien-thi/khach-hang" >
    <div class="row">
        <div class="col">
...
<table class="table">
    ...
    <tbody>
    <c:forEach items="${list.content}" var="nd" varStatus="stt">
        <tr>
            <td>${stt.index+1}</td>
            <td>${nd.ma}</td>
            ...
            <td>${nd.sdt}</td>
            <td>${nd.email}</td>
            <td>${nd.tk.role == false?"Nhân viên":"Khách hàng"}</td>
            <td>
                <a href="/nguoi-dung/view/update1/${nd.id}">
...
<script type="text/javascript">
    function clearFilter(){
        window.location='/nguoi-dung/hien-thi/khach-hang';
    }
</script>
